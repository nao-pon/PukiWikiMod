<?php
// $Id: calendar.inc.php,v 1.2 2003/06/28 11:33:03 nao-pon Exp $
...
';
	...
	while(checkdate($m_num,$day,$year))
	{
		...
		{
			//  Today 
			$ret .= "    <td align=\"center\" class=\"style_td_today\" nowrap><span class=\"small\">$link</span></td>\n"; 
		}
		else if($wday == 0)
		{
			//  Sunday 
			$ret .= "    <td align=\"center\" class=\"style_td_sun\" nowrap><span class=\"small\">$link</span></td>\n";
		}
		else if($wday == 6)
		{
			//  Saturday 
			$ret .= "    <td align=\"center\" class=\"style_td_sat\" nowrap><span class=\"small\">$link</span></td>\n";
		}
		else
		{
			// Weekday 
			$ret .= "    <td align=\"center\" class=\"style_td_day\" nowrap><span class=\"small\">$link</span></td>\n";
		}
		$day++;
		$wday++;
		$wday = $wday % 7;

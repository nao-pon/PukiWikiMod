<?php
// $Id: admin.php,v 1.5 2003/07/05 15:30:06 nao-pon Exp $
...
define("_AM_WIKI_ANONWRITABLE", "<b>編集を許可するユーザー</b>(プラグインでの書き込みを除く)<br />不許可において下の「<b>ページごとの編集権限</b>」より優先します。<br />例えば・・・<br />「<b>管理者のみ</b>」を選択した場合、「<b>ページごとの編集権限</b>」に関わらず、すべてのページが管理者のみしか編集できません。<br />「<b>すべての訪問者</b>」を選択すると、「<b>ページごとの編集権限</b>」で各ページの編集権限をコントロールできるようになります。");
